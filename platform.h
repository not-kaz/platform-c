...
enum platform_mouse_button {
	...
	PLATFORM_MOUSE_BUTTON_LEFT = 1,
	PLATFORM_MOUSE_BUTTON_RIGHT = 2,
	PLATFORM_MOUSE_BUTTON_MIDDLE = 3,
	PLATFORM_MOUSE_BUTTON_WHEEL_UP = 4,
	PLATFORM_MOUSE_BUTTON_WHEEL_DOWN = 5
};
